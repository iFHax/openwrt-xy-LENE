...
git clone --depth 1 https://github.com/Diciya/luci-app-broadbandacc.git package/luci-app-broadbandacc
git clone --depth 1 https://github.com/kiddin9/luci-app-cloudreve.git package/luci-app-cloudreve
git clone --depth 1 https://github.com/kongfl888/openwrt-my-dnshelper.git package/dnshelper
