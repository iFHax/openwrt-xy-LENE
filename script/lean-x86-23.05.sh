...
mv $GITHUB_WORKSPACE/patch/lean/ezopwrt/99-eth-lan-setup package/base-files/files/etc/board.d/99-eth-lan-setup
chmod +x package/base-files/files/etc/uci-defaults/99-eth-lan-setup
